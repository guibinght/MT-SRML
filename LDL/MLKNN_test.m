function [HammingLoss,RankingLoss,OneError,Coverage,Average_Precision,Outputs,Pre_Labels]=MLKNN_test(train_data,train_target,test_data,test_target,Num,Prior,PriorN,Cond,CondN,M)
...
%Computing distances between training instances and testing instances
    ...
    for i=1:num_testing
        ...
        for j=1:num_training
            ...
            dist_matrix(i,j)=(vector1-vector2)*M*(vector1-vector2)';
        end
    end
